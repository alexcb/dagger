...
<Tabs groupId="language" queryString="sdk">
    ...
    ```shell
    dagger module init --sdk=go .dagger/workspace
    ```
    ...
    ```shell
    dagger module init --sdk=python .dagger/workspace
    ```
    ...
    ```shell
    dagger module init --sdk=typescript .dagger/workspace
    ```
    ...
    ```shell
    dagger module init --sdk=php .dagger/workspace
    ```
    ...
    ```shell
    dagger module init --sdk=java .dagger/workspace
    ```
...
```shell
dagger module install ./.dagger/workspace
```
...
```shell
dagger module install github.com/kpenfound/dag/github-issue@b316e472d3de5bb0e54fe3991be68dc85e33ef38
```
