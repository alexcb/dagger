...
Bootstrap a new Dagger module in Go, Python, TypeScript, PHP, or Java by running `dagger module init` in the application's root directory.

<Tabs groupId="language" queryString="sdk">
<TabItem value="go" label="Go">

```shell
dagger module init --sdk=go --name=hello-dagger
```
...
```shell
dagger module init --sdk=python --name=hello-dagger
```
...
```shell
dagger module init --sdk=typescript --name=hello-dagger
```
...
```shell
dagger module init --sdk=php --name=hello-dagger
```
...
```shell
dagger module init --sdk=java --name=hello-dagger
```
